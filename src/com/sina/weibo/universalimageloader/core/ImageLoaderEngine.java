...
class ImageLoaderEngine {
	...
	void submit(final LoadAndDisplayImageTask task) {
		taskDistributor.execute(new Runnable() {
			@Override
			public void run() {
				File image = configuration.diskCache.get(task.getLoadingUri(),task.options.getDiskCacheSubDir());
	...
	private Executor createTaskExecutor() {
		return DefaultConfigurationFactory
				.createExecutor(configuration.threadPoolCoreSize,configuration.threadPoolMaxAliveSize, configuration.threadPriority,
				configuration.tasksProcessingType);
	}

	/**
	 * Returns URI of image which is loading at this moment into passed {@link com.sina.weibo.universalimageloader.core.imageaware.ImageAware}
	 */
	 ...
	 *
	 * @param imageAware {@link com.sina.weibo.universalimageloader.core.imageaware.ImageAware} for which display task
	 *                   will be cancelled
	 */
