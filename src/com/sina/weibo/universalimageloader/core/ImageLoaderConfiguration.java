 ...
 *******************************************************************************/
package com.sina.weibo.universalimageloader.core;
...
import com.sina.weibo.universalimageloader.core.decode.ImageDecoder;
...
public final class ImageLoaderConfiguration {
	...
	final int threadPoolCoreSize;
	final int threadPoolMaxAliveSize;
	...
	private ImageLoaderConfiguration(final Builder builder) {
		...
		threadPoolMaxAliveSize = builder.threadPoolMaxAliveSize;
	 ...
	 * <li>diskCache = {@link com.sina.weibo.universalimageloader.cache.disc.impl.UnlimitedDiscCache}</li>
	...
	public static class Builder {
		...
		public static final int DEFAULT_THREAD_POOL__MAX_ALIVE_SIZE = 3;
		/** {@value} */
		...
		private int threadPoolMaxAliveSize = DEFAULT_THREAD_POOL__MAX_ALIVE_SIZE;
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.sina.weibo.universalimageloader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		...
		public Builder taskExecutor(Executor executor) {
			if (threadPoolCoreSize != DEFAULT_THREAD_POOL_CORE_SIZE || threadPriority != DEFAULT_THREAD_PRIORITY || tasksProcessingType != DEFAULT_TASK_PROCESSING_TYPE) {
		...
		/**
		 * Sets thread pool size for image display tasks.<br />
		 * Default value - {@link #DEFAULT_THREAD_POOL_MAX_ALIVE_SIZE this}
		 */
		public Builder threadPoolMaxAliveSize(int threadPoolMaxAliveSize) {
		    if (taskExecutor != null || taskExecutorForCachedImages != null) {
		        L.w(WARNING_OVERLAP_EXECUTOR);
		    }
		    
		    this.threadPoolMaxAliveSize = threadPoolMaxAliveSize;
		    return this;
		}
		 ...
		 */
		private Builder denyCacheImageMultipleSizesInMemory() {
		 ...
		 * {@link com.sina.weibo.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.sina.weibo.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.sina.weibo.universalimageloader.cache.disc.impl.ext.LruDiscCache LruDiscCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.sina.weibo.universalimageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.sina.weibo.universalimageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.sina.weibo.universalimageloader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.sina.weibo.universalimageloader.cache.disc.impl.UnlimitedDiscCache
		 * BaseDiscCache}. Cache directory is defined by
		 * {@link com.sina.weibo.universalimageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.sina.weibo.universalimageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.sina.weibo.universalimageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.sina.weibo.universalimageloader.utils.L#disableLogging()} to disable
		...
		private void initEmptyFieldsWithDefaultValues() {
			if (taskExecutor == null) {
				taskExecutor = DefaultConfigurationFactory
						.createExecutor(threadPoolCoreSize, threadPoolMaxAliveSize, threadPriority, tasksProcessingType);
			} else {
				customExecutor = true;
			}
...
//				memoryCache = new FuzzyKeyMemoryCache(memoryCache, MemoryCacheUtils.createFuzzyKeyComparator());
	 ...
	 * using {@link com.sina.weibo.universalimageloader.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
