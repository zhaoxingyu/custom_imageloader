...
import com.sina.weibo.universalimageloader.core.assist.LoadedFrom;
...
public class ImageLoader {
     ...
     * @param imageAware {@linkplain com.sina.weibo.universalimageloader.core.imageaware.ImageAware Image aware view}
     ...
     * @param imageAware {@linkplain com.sina.weibo.universalimageloader.core.imageaware.ImageAware Image aware view}
     *                   which should display image
     * @param options    {@linkplain com.sina.weibo.universalimageloader.core.DisplayImageOptions Options} for image
     ...
     * @param progressListener {@linkplain com.sina.weibo.universalimageloader.core.listener.ImageLoadingProgressListener
     *                         Listener} for image loading progress. Listener fires events on UI thread if this method
     *                         is called on UI thread. Caching on disk should be enabled in
     *                         {@linkplain com.sina.weibo.universalimageloader.core.DisplayImageOptions options} to make
     *                         this listener work.
     * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called before
     * @throws IllegalArgumentException if passed <b>imageAware</b> is null
     */
     ...
     * {@link com.sina.weibo.universalimageloader.core.imageaware.ImageAware ImageAware}
     */
     ...
     * {@link com.sina.weibo.universalimageloader.core.imageaware.ImageAware ImageAware}.
     *
     * @param imageAware {@link com.sina.weibo.universalimageloader.core.imageaware.ImageAware ImageAware} for
     ...
     * {@linkplain com.sina.weibo.universalimageloader.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
    ...
    public String loadImageSync(String uri, ImageLoadingListener listener, ImageLoadingProgressListener progressListener,
        ...
        options = new DisplayImageOptions.Builder().cloneFrom(options).syncLoading(true).build();
        ImageSize targetSize = configuration.getMaxImageSize();
        loadImage(uri, targetSize, options, listener, progressListener);
        return configuration.diskCache.get(uri, options.getDiskCacheSubDir()).getAbsolutePath();
    }
}
