...
import com.sina.weibo.universalimageloader.cache.disc.impl.UnlimitedDiscCache;
...
import com.sina.weibo.universalimageloader.core.assist.deque.LIFOLinkedBlockingDeque;
...
public class DefaultConfigurationFactory {
	...
	public static Executor createExecutor(int threadPoolCoreSize,int threadPoolMaxAliveSize, int threadPriority,
			QueueProcessingType tasksProcessingType) {
		boolean lifo = tasksProcessingType == QueueProcessingType.LIFO;
		BlockingQueue<Runnable> taskQueue =
				lifo ? new LIFOLinkedBlockingDeque<Runnable>() : new LinkedBlockingQueue<Runnable>();
		return new ThreadPoolExecutor(threadPoolCoreSize, threadPoolMaxAliveSize, 0L, TimeUnit.MILLISECONDS, taskQueue,
